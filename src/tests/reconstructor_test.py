...
class TestComment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.header_mappings = JSONReader.read_json_to_dict('src/tests/test_mapping.json')
        self.deconst_list = [
            'Labels',
            'Comments'
        ]
    ...
    def test_reformat_tmp_issue_labels(self):
        ...
        target_issue = self.test_issue1.copy()

        test_issue = self.test_issue1.copy()

        target_issue.attributes['Labels1'] = 'pipeline_review'
        target_issue.attributes['Labels2'] = 'status::needs_review'
        target_issue.attributes['Labels3'] = 'unittest'

        Reconstructor.reformat_tmp_issue(test_issue, deconst_attribute='Labels')
    ...
    def test_reformat_tmp_issue_comments(self):
        ...
        target_issue = self.test_issue2.copy()

        test_issue = self.test_issue2.copy()
    ...
    def test_reformat_tmp_issue_comments_wrong_attr(self):
        ...
        test_issue = self.test_issue4.copy()
        target_issue = self.test_issue4.copy()
    ...
    def test_check_spaces_from_attr_labels(self):
        ...
        return_str1 = Reconstructor.check_spaces_from_attr('Labels', test_label1)
        return_str2 = Reconstructor.check_spaces_from_attr('Labels', test_label2)
        return_str3 = Reconstructor.check_spaces_from_attr('Labels', test_label3)
    ...
    def test_check_spaces_from_attr_comments(self):
        ...
        return_str = Reconstructor.check_spaces_from_attr('Comments', 'This is my comment!')
    ...
    def test_update_headers(self):
        ...
        header_mappings = self.header_mappings.copy()
        target_headers_dict = self.header_mappings.copy()
